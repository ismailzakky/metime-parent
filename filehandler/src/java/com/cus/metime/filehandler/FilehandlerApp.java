package com.cus.metime.filehandler;

import com.cus.metime.filehandler.client.OAuth2InterceptedFeignConfiguration;
...
public class FilehandlerApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(FilehandlerApp.class);

    private final Environment env;

    public FilehandlerApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FilehandlerApp.class);
