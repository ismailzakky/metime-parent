package com.cus.metime.promosi;

import com.cus.metime.promosi.client.OAuth2InterceptedFeignConfiguration;
...
public class PromosiApp {
    ...
    public PromosiApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PromosiApp.class);
